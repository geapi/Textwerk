...
/** @class
  ...
  @version 0.1
*/
TextWerk.Paper = SC.Record.extend( LinkIt.Node,
/** @scope TextWerk.Paper.prototype */ {
  primaryKey: 'id',
  name: SC.Record.attr(String, { isRequired: YES, defaultValue: 'Enter Name' }),

  title: SC.Record.attr(String, { isRequired: NO, defaultValue: 'some title' }),
  author: SC.Record.attr(String, { isRequired: NO, defaultValue: 'maria mustermann' }),
  year: SC.Record.attr(String, { isRequired: NO, defaultValue: '1899' }),
  venue: SC.Record.attr(String, { isRequired: NO, defaultValue: 'sample venue' }),

  collection: SC.Record.attr('TextWerk.Collection'),
  referrer: SC.Record.attr('TextWerk.Paper'),
  citee: SC.Record.attr('TextWerk.Paper'),
